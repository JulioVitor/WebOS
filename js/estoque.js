...
async function carregarProdutos() {
    try {
        ...
        // ✅ CORREÇÃO: URL simples sem parâmetros problemáticos
        ...
        if (response && response.ok) {
            ...
            console.log(`✅ ${produtos.length} produtos ativos carregados`);
            renderizarProdutos();
        } else {
...
function renderizarProdutos(produtosFiltrados = null) {
    ...
    lista.forEach(produto => {
        ...
        row.innerHTML = `
            ...
            <td>
                <strong>R$ ${produto.preco_venda?.toFixed(2) || '0.00'}</strong>
